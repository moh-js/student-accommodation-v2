...
return [
    ...
    'country_code' => '255', //Country code to be added
    'default' => env('SMS_API_DEFAULT_GATEWAY', 'nextsms'), //Choose default gateway
    
//    Basic Gateway Sample Configuration
    'nextsms' => [
        'method' => 'POST', //Choose Request Method (GET/POST) Default:GET
        'url' => 'https://messaging-service.co.tz/api/sms/v1/test/text/single', //Base URL
        'params' => [
        ...
        'headers' => [
            ...
            'Authorization' => 'Basic bW9oX3NhaWQ6M3pGYUpzV0BONUJaeVB0',
